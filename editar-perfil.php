  ...
  <body>
    ...
    <div class="section row2">
      <div id="container" align="center">
        ...
        <br>
          <form id="regform" style="border: 0px;" method="POST" action=" " onsubmit="return(validarForm())" enctype="multipart/form-data">
            <h1 class="title-pen">Modificar perfil</h1></h2>

            <div class="formfield">
              <label for="nombre"><b>Nombre</b></label>
              <input type="text" name="nombre" id="nombre" placeholder="ACA TIENE QUE IR EL NOMBRE ACTUAL">
            </div>

            <div class="formfield">
              <label for="apellido"><b>Apellido</b></label>
              <input type="text" name="apellido" id="apellido" placeholder="ACA TENES Q PONER EL APELLIDO ACTUAL">
            </div>

            <div class="formfield">
              <label for="email"><b>Correo electrónico</b></label>
              <input type="text" name="email" id="email" placeholder="MAIL ACUTAL">
            </div>
